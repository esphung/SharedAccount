...
describe("SharedAccountTextInput", () => {
  ...
  it("renders with custom placeholder", () => {
    ...
    const { getByPlaceholderText } = render(<SharedAccountTextInput placeholder={placeholder} />);
  ...
  it("calls onChangeText when text changes", () => {
    ...
    const { getByPlaceholderText } = render(<SharedAccountTextInput onChangeText={onChangeText} />);
  ...
  it("applies custom style", () => {
    ...
    const input = getByPlaceholderText("Type here...");
    expect(input.props.style).toEqual(expect.arrayContaining([expect.objectContaining({ backgroundColor: "yellow" })]));
  });
});
